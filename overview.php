...
<div class="content">
    <div class="container col-xl-9 first-container">
        ...
        <div class="project-card-container">
            <?php
            createProjectCards([
                ['MS Paint IDE', 'Java', '235', '565', 'The main application for the project, contains the GUI and other primary working components of the IDE.', 'https://github.com/MSPaintIDE/MSPaintIDE'],
