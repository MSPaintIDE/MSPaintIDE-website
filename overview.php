...
<div class="content">
    <div class="container col-xl-9 first-container">
        ...
        <div class="project-card-container">
            <?php
            createProjectCards([
                ['MS Paint IDE', 'Java', '220', '555', 'The main application for the project, contains the GUI and other primary working components of the IDE.', 'https://github.com/MSPaintIDE/MSPaintIDE'],
                ['NewOCR', 'Java', '226', '29', 'The completely custom OCR used by the IDE to get characters from input images. This is used by the IDE but can be used for any application.', 'https://github.com/MSPaintIDE/NewOCR'],
